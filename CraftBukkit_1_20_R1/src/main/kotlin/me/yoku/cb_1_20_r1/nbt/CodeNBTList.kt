package me.yoku.cb_1_20_r1.nbt
...
open class CodeNBTList<T> : NBTList<T> {
    ...
    constructor() { this.tag = ListTag() }

    constructor(tag: ListTag) { this.tag = tag }
    ...
    override fun iterator(): Iterator<T> { return NBTIterator(this) }

    override fun toArray(): Array<Any?> { return arrayOf(toList()) }

    inline fun <reified C> toTypeArray() : Array<C> { return (toList() as List<C>).toTypedArray() }
