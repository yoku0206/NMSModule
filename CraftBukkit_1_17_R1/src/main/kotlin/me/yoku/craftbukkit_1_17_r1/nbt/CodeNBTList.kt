...
open class CodeNBTList<T> : NBTList<T> {
    ...
    override fun getOwnType(): NBTType {
        return CodeNBTType.fromNMS(this.tag.elementType.toInt())
    }
    ...
    override fun clone(): NBTList<T> { return CodeNBTList(tag.clone()) }
